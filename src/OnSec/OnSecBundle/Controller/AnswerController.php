...
use OnSec\OnSecBundle\Entity\Answer;
...
class AnswerController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $answers = $em->getRepository('HSDOnSecBundle:Answer')->findAll();

        return $this->render('HSDOnSecBundle:Answer:index.html.twig', array(
            'answers' => $answers,
        ));
    }
    ...
    {
        $answer = new Answer();
        $form = $this->createForm('OnSec\OnSecBundle\Form\AnswerType', $answer);
        ...
        return $this->render('HSDOnSecBundle:Answer:new.html.twig', array(
            'answer' => $answer,
    ...
    public function showAction(Answer $answer)
    {
        ...
        return $this->render('HSDOnSecBundle:Answer:show.html.twig', array(
            'answer' => $answer,
    ...
    {
        $deleteForm = $this->createDeleteForm($answer);
        $editForm = $this->createForm('OnSec\OnSecBundle\Form\AnswerType', $answer);
        ...
        return $this->render('HSDOnSecBundle:Answer:edit.html.twig', array(
            'answer' => $answer,
